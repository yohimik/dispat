...
are pointers, so an unset object marshals as an absent key rather than `{}`
...
Go 1.22 or later. One dependency: the workspace's own [`pkg/ccme`](../ccme) (for the resolved parser configuration
type).
