...
| `TestNPMDistributionFirstReleaseUsesExactVersionAndChoreCorrections` | An unreleased npm baseline and exact 1.10.0 intent publish only npm and docs; chore corrections remove accidental native release propagation, retain the published binary, and converge on retry. |
