...
| `TestFleetSourceRemoteReadFailureStopsBeforePublicationAndCanRetry` | Failure to prove a source remote stops the fleet before publishing; retry under the same push policy publishes once and records the exact source tag remotely. |
