...
| `TestDownloadRefusesAFolderItCannotWriteTo` | The first failure a real install meets, since /usr/local/bin belongs to root on most machines: the refusal arrives before the transfer rather than after it, and says what to do about it. |
