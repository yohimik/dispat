...
// newPushingCheckout is one repository whose release pushes its commit to a
// bare remote, with a package that has work pending.
func newPushingCheckout(t *testing.T) *harness.Repo {
	t.Helper()
	r := harness.New(t)
