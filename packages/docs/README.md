...
[`scripts/render-logo.py`](../../scripts/render-logo.py) generates `imgs/logo.png` for the README and social card,
the icons in [`static/img/`](./static/img), and `static/favicon.ico`. It draws the grid
