...
//
// The four measured Internals pages are .mdx rather than .md, and are the
// exception on purpose: their figures come from the report a release measured,
// so they are components rather than text, and there is nothing for GitHub to
// render correctly.
//
  ...
  docs: [
      ...
      items: [
        ...
        {type: 'doc', id: 'examples/document-artifacts', label: 'Skills, specifications and TeX'},
        {
          ...
          items: [
            ...
            {type: 'doc', id: 'examples/php', label: 'Composer packages'},
            {type: 'doc', id: 'examples/ruby', label: 'Ruby gems'},
            {type: 'doc', id: 'examples/flutter', label: 'Flutter and Dart'},
    ...
    },
    {
      ...
      items: [
        ...
        {type: 'doc', id: 'reference/ci-providers', label: 'Other CI providers'},
    ...
    {type: 'doc', id: 'faq', label: 'FAQ'},
    {
      ...
      items: [
        ...
        {type: 'doc', id: 'internals/experiments', label: 'Release experiments'},
      ],
    },
  ],
  api: [
    ...
    },
    {
      ...
      items: [
        ...
        {type: 'doc', id: 'configuration/autosign', label: 'autoSign'},
