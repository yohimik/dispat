...
export default function DocsVersionDropdownNavbarItem({
  ...
  function versionItemToLink({
    ...
    return {
      label,
      // A version is a different page. Keep query state, but never carry a
      // heading anchor into that page implicitly. Authored links with hashes
      // and same-page anchor navigation remain unchanged.
      to: `${targetDoc.path}${search}`,
