...
A [versioning group](../releasing/versioning.md) is the softer case: a selection that takes only part of one releases and warns
...
The full guide, with worked output, is [Partial releases](../releasing/partial-releases.md).
...
The full guide, including how to clear a lock a killed run left behind, is [The release lock](../releasing/release-lock.md).
