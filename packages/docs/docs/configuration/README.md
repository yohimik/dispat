...
| `dependencies`     | map consumer → providers                   | no       | Consumer → provider relations between packages; see [`dependencies`](#dependencies) below. Spaces and packages declare their own too.                                                                                |
