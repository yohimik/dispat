...
| app       | Unit tests of its helpers: commit-message templating, github repository/token resolution, the initials mapping (case-insensitive, unmatched keys warned), the --on-error validator, the init starter configs, the git-prerequisites guard (missing git binary / missing .git). The composition claims (release flows, hooks, finalize, records) live in the black-box `tests/integration` suite.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
