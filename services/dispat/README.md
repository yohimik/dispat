...
| [dependencies](https://yohimik.github.io/dispat/configuration/dependencies)                          | Declaring the consumer/provider relations the graph orders releases by, and the three levels one can be written at.                                                                                     |
