...
**Version:** 3.1.0-rc.1 **Status:** Normative specification; new protocol implementation pending **Extends:** Conventional
...
An implementation conforms to CCME 3.1.0-rc.1 if and only if it:
