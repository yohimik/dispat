...
**Version:** 3.1.0-rc.4 **Status:** Normative specification; adapter and rollback protocols pending implementation
...
An implementation conforms to CCME 3.1.0-rc.4 if and only if it:
...
This document is CCME **3.1.0-rc.4** and is itself versioned under SemVer:
