...
**Version:** 3.1.0-rc.0 **Status:** Normative specification; new protocol implementation pending **Extends:** Conventional
...
An implementation conforms to CCME 3.1.0-rc.0 if and only if it:
...
This document is CCME **3.1.0-rc.0** and is itself versioned under SemVer:
