...
**Version:** 3.1.0-rc.3 **Status:** Normative specification; adapter and rollback protocols pending implementation
...
An implementation conforms to CCME 3.1.0-rc.3 if and only if it:
...
This document is CCME **3.1.0-rc.3** and is itself versioned under SemVer:
